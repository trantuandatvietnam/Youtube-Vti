import { IIcons } from './Icons.model';

export const MenuIcon = ({ width = '24px' }: IIcons) => {
    return (
        <svg
            viewBox="0 0 24 24"
...
export const LogoIcon = ({ width = '90px' }: IIcons) => {
    return (
        <svg
            viewBox="0 0 90 20"
            preserveAspectRatio="xMidYMid meet"
...
export const MicIcon = ({ width = '24px' }: IIcons) => {
    return (
        <svg
            viewBox="0 0 24 24"
            preserveAspectRatio="xMidYMid meet"
...
export const SearchIcon = ({ width = '24px' }: IIcons) => {
    return (
        <svg
            viewBox="0 0 24 24"
            preserveAspectRatio="xMidYMid meet"
...
export const UploadIcon = ({ width = '24px' }: IIcons) => {
    return (
        <svg
            viewBox="0 0 24 24"
            preserveAspectRatio="xMidYMid meet"
...
export const NotifyIcon = ({ width = '24px' }: IIcons) => {
    return (
        <svg
            viewBox="0 0 24 24"
            preserveAspectRatio="xMidYMid meet"
...
export const HomeIcon = ({ width = '24px' }: IIcons) => {
    return (
        <svg
            viewBox="0 0 24 24"
            preserveAspectRatio="xMidYMid meet"
            focusable="false"
            className="styleScope ytIcon"
            style={{
                pointerEvents: 'none',
                display: 'block',
                width,
